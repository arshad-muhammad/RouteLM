...
import { Search, SlidersHorizontal, ArrowRight, Play, Info, Terminal, RefreshCw, X } from "lucide-react";
      ...
      <div className="flex flex-col md:flex-row gap-3 items-center justify-between bg-[#0C0C0E] p-4 border border-[#27272A] rounded">
        ...
        <div className="flex flex-wrap gap-2 w-full md:w-auto">
          ...
          <button
            ...
            className="p-1 px-3 flex items-center space-x-1.5 bg-[#18181B] border border-[#27272A] hover:bg-zinc-800 rounded text-xs font-mono text-[#A1A1AA] transition select-none cursor-pointer"
          >
