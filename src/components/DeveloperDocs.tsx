      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-neutral-900 pb-4">
        <div>
          <h2 className="text-sm font-semibold uppercase tracking-wider font-mono text-white flex items-center gap-2">
            ...
            <span>Developer Guide & API Docs</span>
          </h2>
          <p className="text-[11px] text-neutral-400 font-sans mt-1">
            Learn how to connect our backup routing service to your apps in just a few steps.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div className="lg:col-span-1 space-y-4">
          <div className="bg-[#0C0C0E] border border-neutral-800 p-5 rounded-lg space-y-4.5">
            <div className="flex items-center gap-2 pb-2 border-b border-neutral-850">
              ...
              <h3 className="font-mono text-[10px] uppercase font-bold tracking-widest text-white">Documentation Index</h3>
            </div>
            ...
            <ul className="space-y-2.5 font-mono text-[11px] text-neutral-450 text-neutral-400 font-medium">
              <li className="flex items-center gap-2 text-cyan-400 hover:underline cursor-pointer">
                <span>&rarr;</span> <span>Quickstart Guide</span>
              </li>
              <li className="flex items-center gap-2 hover:text-white cursor-pointer transition">
                <span>&rarr;</span> <span>How Backup Routing Works</span>
              </li>
              <li className="flex items-center gap-2 hover:text-white cursor-pointer transition">
                <span>&rarr;</span> <span>Smart Cost Savings</span>
              </li>
              <li className="flex items-center gap-2 hover:text-white cursor-pointer transition">
                <span>&rarr;</span> <span>API Key Security</span>
              </li>
              <li className="flex items-center gap-2 hover:text-white cursor-pointer transition">
                <span>&rarr;</span> <span>Error Resolution</span>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-neutral-900/60 p-4 border border-neutral-850 rounded-md">
            <div className="flex gap-2">
              ...
              <div>
                <p className="font-mono text-[10px] font-bold uppercase text-white">Uptime & Speed Guarantee</p>
                <p className="text-[10px] text-neutral-500 mt-1 leading-normal font-sans">
                  Our servers run on highly secure, triple backup paths to make sure your routing endpoint delivers 100% of your requests.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="lg:col-span-2 bg-[#0C0C0E] border border-neutral-800 p-6 rounded-lg space-y-5">
          <div className="space-y-2">
            <h3 className="font-sans font-bold text-base text-white">Continuous Backup Routing</h3>
            <p className="text-[11px] text-neutral-400 leading-relaxed font-sans">
              To keep your applications running without interruption, RouteLM automatically watches for connection issues or limits. If a model is slow or error-prone, we securely reroute your query.
            </p>
          </div>

          <div className="space-y-2 pt-2">
            <h4 className="font-mono text-[10px] font-bold uppercase text-white tracking-wider">Example Backup Routing Configuration</h4>
...
{`{
  ...
  "maxRetryAttempts": 3
          ...
          <div className="space-y-2 pt-2">
            <h4 className="font-sans font-bold text-sm text-white">Automatic Cost Savings</h4>
            <p className="text-[11px] text-neutral-400 leading-relaxed font-sans">
              When you choose the COST Routing Preference, your prompt is checked for size and complexity. If the prompt is simple, we route it directly to faster, lower-cost models to save you money.
            </p>
          </div>
          ...
          <div className="space-y-2 pt-2 border-t border-neutral-900 pt-4">
            <div className="flex items-center gap-1.5 text-[11px] font-mono text-cyan-400 font-bold uppercase">
              ...
              <span>Backup Routing Active</span>
            </div>
          </div>
        </div>
